...
const ContactHero = () => {
  ...
  return (
    <div className="relative pt-[220px] pb-[140px] overflow-hidden bg-secondary">
      ...
      {/* Floating Communication Icons Animation */}
        ...
        <div className="max-w-[750px]">
          ...
          >
            ...
            <h1 className="text-white text-[45px] md:text-[60px] font-bold mb-6 leading-tight">
              {isAmharic ? "ከእኛ ጋር " : "Get in "}
              <span className="text-primary italic">{isAmharic ? "ይገናኙ" : "Touch"}</span>
            </h1>

            <p className="text-white/70 text-[18px] mb-10 leading-relaxed max-w-[600px]">
              {isAmharic 
                ? "ጥያቄ አለዎት? ወይም አስተያየት መስጠት ይፈልጋሉ? በማንኛውም ጊዜ ሊያገኙን ይችላሉ።" 
                : "Have a question? or want to provide feedback? You can reach us anytime through our contact channels."}
            </p>
            ...
            <div className="flex items-center gap-4 text-white font-medium">
              ...
              <span className="text-primary">{t('nav.contact')}</span>
            </div>
          </motion.div>
        </div>
      </div>
