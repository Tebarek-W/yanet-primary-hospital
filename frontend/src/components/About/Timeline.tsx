...
const Timeline = () => {
  ...
  const milestonesData: Record<string, { icon: any; color: string; bgLight: string }> = {
    ...
    <section className="section-padding bg-[#f9fdfe] relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center mt-12">
          {/* Left: Interactive Navigation Track (lg:col-span-4) */}
          ...
          {/* Right: Milestone Card Display (lg:col-span-8) */}
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-6 items-start relative z-10">
                  {/* Icon Container */}
                  <div className={`p-4 rounded-2xl ${milestonesData[selectedYear].bgLight} ${milestonesData[selectedYear].color} flex items-center justify-center shrink-0`}>
                    {milestonesData[selectedYear].icon}
                  </div>
                  ...
                  <div>
                    ...
                    <h3 className="text-[22px] font-bold text-secondary mb-3 leading-tight">
                      {t(`about_timeline.years.${selectedYear}.title`)}
                    </h3>
